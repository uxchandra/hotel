    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <p class="navbar-brand">Hotel Pennsylvania</p>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children active dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-hotel"></i><a href="<?= site_url('Venue/read') ?>">Venue</a></li>
                                <li><i class="fa fa-users"></i><a href="<?= site_url('MeetingRoom/read') ?>">Meeting Room</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" style="height: 40px; width: 35px;" src="<?= base_url('images/pengguna/image.png'); ?>"> </a>
                        </a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?= $i++ ?></td>
                                                <td><img src="<?= base_url('images/meeting_room/' . $kmr->gambar) ?>" width="150px" height="100px"></td>
                                                <td><?= $kmr->jenis ?></td>
                                                <?php if ($tampil == true) {
                                                    $tampil = $kmr->kapasitas - $tampil->kapasitas;
                                                } else {
                                                    $tampil = $kmr->kapasitas;
                                                } ?>
                                                <td><?= $tampil ?></td>
                                                <td><?= $kmr->harga ?></td>

                                                <td>
                                                    <a class="btn btn-success" href="<?= site_url('MeetingRoom/edit/' . $kmr->id) ?>">Edit</a>
                                                    <a class="btn btn-danger" href="<?= site_url('MeetingRoom/delete/' . $kmr->id) ?>" onclick="return confirm('Apakah Anda Yakin?')">Delete</a>
                                                </td>
                                                <!-- <td>
                                                <?php
                                                if ($cat->sold_049 == 1) {
    ...
    <div id="contact-modal" class="modal fade" role="dialog" style="margin-top: 200px">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?= site_url('MeetingRoom/do_upload') ?>" method="post" enctype="multipart/form-data" novalidate="novalidate">
                    <div id="pay-invoice">
                        <div class="card-body">
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="cc-exp" class="control-label mb-1">Kapasitas</label>
                                        <input id="cc-exp" name="kapasitas" type="tel" class="form-control ">
                                    </div>
                                </div>
                                <div class="col-6">
