                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children active dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-users"></i><a href="<?= site_url('Meeting/read') ?>">Meeting Room</a></li>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="<?= site_url('Venue/read') ?>">Kembali</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ubah Data Venue <?= $detail->jenis ?></h3>
                                        </div>
                                        <hr>
                                        <form action="<?= site_url('Venue/update/' . $detail->id) ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <img src="<?= base_url('images/venue/' . $detail->gambar) ?>" width="450px" height="280px">
                                            </div>
